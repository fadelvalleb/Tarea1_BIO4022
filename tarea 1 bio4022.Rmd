...
kable(Perros_Tidy, caption=" Tabla 1. Especies del género Canis y sus pesos correspondientes ", row.names = F , digits = 2) %>% kable_styling(bootstrap_options = c("striped", "hover", full_width = F))
...
```{r, fig.cap = " Figura 1. Representación de Peso en Kg de las especies del género Canis que se encuentran en la base de datos Pantheria"}
